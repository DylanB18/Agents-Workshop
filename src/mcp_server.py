"""
mcp_server.py — Literature Review MCP Server (pre-implemented)
...
You do not need to modify this file, but reading through it will help you
understand how tool descriptions influence agent behavior.
